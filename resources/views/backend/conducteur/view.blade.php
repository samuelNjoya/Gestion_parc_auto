                ...
                <div class="card-body">
                    ...
                    <dl class="info-list">
                        ...
                        <div class="info-item">
                         ...
                         <div class="info-item">
                            <dt><i class="fas fa-id-card me-2"></i> Type de permis</dt>
                            <dd>{{$getRecords->type_permis}}</dd>
                        </div>
                        <div class="info-item">
                            <dt><i class="fas fa-id-card me-2"></i> Numéro de permis</dt>
                            <dd>{{$getRecords->num_permis}}</dd>
                        </div>
                        <div class="info-item">
                            <dt><i class="fas fa-calendar-alt me-2"></i> Date d’expiration</dt>
                            <dd>{{$getRecords->date_exp_permis}}</dd>
                        </div>
                        <div class="info-item">
                            <dt><i class="fas fa-user-shield me-2"></i> Rôle</dt>
                            <dd>{{ ($getRecords->role == 4) ? 'conducteur' : '/' }}</dd>
                        </div>
                          <p>
