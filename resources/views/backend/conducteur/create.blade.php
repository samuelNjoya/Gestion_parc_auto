                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group side-by-side">  
                     ...
                     <div class="form-group side-by-side">
                         <div>
                            ...
                            <input type="text" id="license_expiry" name="numero_permis" placeholder="Entrer une numero de permis"  aria-required="true" value="{{ old('numero_permis') }}">
                        </div>
                        <div>
                    ...
                    <div class="form-group side-by-side">
                        <div>
                            ...
                            <input type="date" id="birth_date" name="date_expiration_permis"  aria-required="true" value="{{ old('date_expiration_permis') }}">
                        </div>
                        <div>
