...
@section('content')
    <div class="add-form-container fade-in">
        <div class="card mb-4">
            <div class="card-body">
                <h2 class="fw-bold">Ajouter un Ravitaillement</h2>
                <form action=""  method="POST">
                    ...
                    <div class="form-group side-by-side">
                        <div class="form-group full-width">
                         ...
                         <div class="form-group">
                            ...
                            <input type="number" id="mileage" name="kilometrage_plein" value="{{ old('kilometrage_plein') }}" min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group side-by-side">
                        <div class="form-group">
                            ...
                            <input type="date" id="date" name="date_conso" value="{{ old('date_conso') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="quantity">Quantité (L)</label>
                            <input type="number" id="quantity" name="quantite_conso" value="{{ old('quantite_conso') }}" step="0.01" min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group side-by-side">
                        <div class="form-group">
                            ...
                            <input type="number" id="cost" name="cout_conso" value="{{ old('cout_conso') }}" step="0.01" min="0" required>
                        </div>
                        <div class="form-group full-width">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="notes" name="note" value="{{ old('note') }}" placeholder="Détails supplémentaires (optionnel)"></textarea>
                    </div>
